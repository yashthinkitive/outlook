...
const CardComponent: React.FC<CardComponentProps> = ({
  ...
  const moreIconButtonRef = useRef<null | HTMLButtonElement>(null);
  ...
  const handleDoubleClick = () => {
    if (moreIconButtonRef.current) {
      setAnchorEl(moreIconButtonRef.current);
    }
  };
  ...
  return (
    <Card className={`${className} ${containerClass}`} sx={{ mb: 1 }} onDoubleClick={handleDoubleClick}>
      <CardContent>
